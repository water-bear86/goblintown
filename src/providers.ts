...
// Production policy: goblin/gremlin/raccoon/troll/pigeon/scribe default to lower-cost,
// ogre keeps a premium model reserved for heavy fallback.
const OPENAI_DEFAULT_LOW_COST_MODEL = "gpt-5-mini";
const OPENAI_DEFAULT_PREMIUM_MODEL = "gpt-5";

const OPENAI_MODELS: Record<ModelSlot, string> = {
  goblin: OPENAI_DEFAULT_LOW_COST_MODEL,
  // Gremlin intentionally stays compact by default for lower-cost adversarial pressure.
  gremlin: OPENAI_DEFAULT_LOW_COST_MODEL,
  raccoon: OPENAI_DEFAULT_LOW_COST_MODEL,
  troll: OPENAI_DEFAULT_LOW_COST_MODEL,
  ogre: OPENAI_DEFAULT_PREMIUM_MODEL,
  pigeon: OPENAI_DEFAULT_LOW_COST_MODEL,
  scribe: OPENAI_DEFAULT_LOW_COST_MODEL,
